...
public class modelclassforadmin {
    String name,email,number,adress,age,vaccinecenter,firstdose,seconddose;
    public modelclassforadmin(){

    }
    public modelclassforadmin(String name, String email,  String number, String adress, String age,String vaccinecenter, String firstdose, String seconddose){
        this.name = name;
        this.email = email;
